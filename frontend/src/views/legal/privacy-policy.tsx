      ...
      <Wrapper>
        <div className="max-w-4xl mx-auto text-white/80 space-y-8">
          ...
          <div className="space-y-6 text-sm sm:text-base leading-relaxed">
            <p>
              This Privacy Policy explains how Bismillah Wholesale ("we", "us",
            ...
            <div className="space-y-2">
              ...
              <ul className="list-disc list-inside space-y-1 text-white/70">
                <li>
                  Contact details (name, email, phone) submitted through forms.
                </li>
                <li>Order and delivery information when you place an order.</li>
                <li>
                  Usage data such as pages viewed and interactions (via
                  analytics tools).
                </li>
              </ul>
            </div>
            ...
            <div className="space-y-2">
              ...
              <p className="text-white/70">
                ...
                service providers (e.g., email, hosting, delivery) only as
