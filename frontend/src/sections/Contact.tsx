...
const Contact: React.FC = () => {
  ...
  const emailServiceId = import.meta.env.VITE_EMAILJS_SERVICE_ID as
    | string
    | undefined;
  const emailTemplateId = import.meta.env.VITE_EMAILJS_TEMPLATE_ID as
    | string
    | undefined;
  const emailPublicKey = import.meta.env.VITE_EMAILJS_PUBLIC_KEY as
    | string
    | undefined;
  ...
  const contactInfo = [
    {
      ...
      details: [
        ...
        "orders@bismillahwholesale.com",
      ],
    },
    {
      icon: Phone,
      title: "Call Us",
      details: ["+44 7344 231811", "+44 7344 231811"],
    },
    {
      icon: MapPin,
      title: "Visit Us",
      ...
      <Wrapper>
        ...
        <div className="contact-header text-center mb-10 sm:mb-16 opacity-0">
          ...
          <p className="text-white/60 max-w-2xl mx-auto text-sm sm:text-base lg:text-lg px-2 sm:px-0">
            Have questions about our wholesale program? We would love to hear
            from you. Reach out and our team will get back to you within 24
            hours.
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-3 gap-6 sm:gap-8">
          ...
          <div className="contact-form lg:col-span-2 opacity-0">
            <form
              ...
              className="p-4 sm:p-6 lg:p-8 bg-white/5 border border-gold/20"
            >
              <h3
                className="text-xl sm:text-2xl text-white font-semibold mb-4 sm:mb-6"
                style={{ fontFamily: "Playfair Display, serif" }}
              >
                Send us a Message
              </h3>
